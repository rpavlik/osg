...
STD_VECTOR_REFLECTOR(osg::MixinVector< GLsizei >)

STD_VECTOR_REFLECTOR(osg::MixinVector< GLubyte >)

STD_VECTOR_REFLECTOR(osg::MixinVector< GLuint >)

STD_VECTOR_REFLECTOR(osg::MixinVector< GLushort >)
